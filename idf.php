...
$query = "SELECT d.kata,d.katajmldok,e.jmldok,LOG10(e.jmldok/d.katajmldok) idf from (SELECT kata,COUNT(kata) katajmldok FROM tfidf GROUP BY kata) AS d JOIN (SELECT COUNT(id) jmldok FROM (SELECT * FROM tfidf GROUP BY id) AS c) AS e";
